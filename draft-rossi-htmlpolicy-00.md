...
* The HTML must render correctly on a list of browser versions that the RFC Editor will keep up to date outside of this document. The RPC must consider both the probable longevity of wide support and security implications for their implementation decisions.
